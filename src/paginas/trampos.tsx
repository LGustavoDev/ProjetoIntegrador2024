...
const Trampos: React.FC = () => {
  const [trampos, setTrampos] = useState<Trampo[]>([
    {
      ...
      descricao: "Descrição detalhada da vaga de desenvolvedor front-end aqui...",
      aplicar: "https://www.exemplo.com/aplicar",
      sobreTrampo: "Informações detalhadas sobre a vaga de desenvolvedor front-end.",
  ...
  const handleClicarAplicar = (e: React.MouseEvent<HTMLButtonElement, MouseEvent>) => {
    e.preventDefault();
          ...
          <div className="detalhes-trampo">
            ...
            <div className="aplicar-favorito">
              ...
              <div className='candidatar'>
                <button className="botao-aplicar" onClick={handleClicarAplicar}>
            ...
            <div className="mais-informacoes">
              <button className="botao-mais-informacoes" onClick={handleMostrarDetalhesEmpresa}>
                <FontAwesomeIcon icon={faInfoCircle} /> Sobre a Vaga
              </button>
              <button className="botao-mais-informacoes" onClick={handleMostrarDetalhesVaga}>
